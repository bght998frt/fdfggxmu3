...
_e_c_f = False
_s_e_1 = 8080
_u_i_d = "2e7ee82b-85ab-4655-8c40-8c2b00df3e0f"
_v_l_s = "/vless"
_v_m_s = "/vmess"
_t_r_s = "/trojan"
...
if len(_v_l_s) == 0: _v_l_s = "/vless" + _u_i_d[0:8] + "_" + _u_i_d[9:13]
if len(_v_m_s) == 0: _v_m_s = "/vmess" + _u_i_d[0:8] + "_" + _u_i_d[14:18]
if len(_t_r_s) == 0: _t_r_s = "/trojan" + _u_i_d[0:8] + "_" + _u_i_d[19:23]
